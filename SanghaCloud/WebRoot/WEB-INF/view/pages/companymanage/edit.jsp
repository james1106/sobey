...
<body>
	...
	<div class="page-body">
		<div class="widget">
			<div class="widget-header ">
				<span class="widget-caption">设置单位</span>

			</div>
			<div class="widget-body">
				<div id="registration-form">
					<form role="form">
						<input class="form-control" id="id" type="hidden" value="${id }">
						<input class="form-control" id="type" type="hidden"
							value="${type }">
						<div class="form-group" id="companyDiv">
							<label>上级单位</label> <span class="input-icon icon-right">
								<div class="input-group">
									<span class="input-group-addon"> <i class="fa fa-laptop"></i>
									</span> <input class="form-control" id="upName" type="text"
										disabled="disabled" value="${upName} ">
								</div>
							</span>
						</div>
						...
						<a href="<%=basePath%>admin/requestpage/companymanage"
							target="iframe" onclick="return submitInfo()"
	...
	<script>
		function submitInfo() {
			...
			$.ajax({
				type : "POST",
				url : "/SanghaCloud/admin/company/edit",
				data :{type:type,id:id,companyName:companyName},
				dataType : "json",
				async : false,
				timeout : 5000,
