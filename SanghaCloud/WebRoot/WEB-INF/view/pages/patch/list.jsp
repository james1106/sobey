...
<body>
    ...
    <div class="page-body">
		<div class="widget">
			<div class="widget-header ">
                <span class="widget-caption">补丁统计</span>
            ...
            <div class="widget-body">
         		<div class="row">
		          <div class="col-sm-12">
		            <label>
		             	<input type="text" name="name" id="name" class="form-control input-sm" placeholder="按姓名查找"/>
		            </label>
		            <label>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/patch/list.js"></script>
    <script>
    	var totalpage=10;
    	$(function(){
    		addpage(); //加载分页方法
    		...
    		$.jqPaginator('#pagination', {
	   	        ...
	   	        onPageChange: function (num, type) {
	   	            ...
	   	            if(type != "init"){
	   	            	...
	   	            	totalpage = initData(num,realName);
	   	            }
	   	        }
	   	    });   
    	})
