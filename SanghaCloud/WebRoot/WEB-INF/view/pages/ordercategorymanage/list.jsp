...
<body>
	...
	<div class="page-body">
		<div class="widget">
			<div class="widget-header ">
				<span class="widget-caption">查看分类</span>
				<div class="widget-buttons">
					<a href="<%=basePath%>admin/requestpage/ordercategorymanage/add" target="iframe" class="btn btn-warning">添加分类</a>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="<%=basePath%>resource/js/ordercategorymanage/list.js"></script>
	...
	<script>
		...
		$("#qShoppingTemplet").click(
				function() {
					var realName = $("#realName").val();
					if (realName.length == 0 || realName == null) {
						Notify("请输入要查找的人", 'top-right', '5000', 'danger',
								'fa-desktop', true);
					} else {
						var type = $("#type").val();
