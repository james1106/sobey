...
<body>
    ...
    <div class="page-body">
		<div class="widget">
			<div class="widget-header ">
                <span class="widget-caption">更新设备</span>
                <div class="widget-buttons">
                </div>
            </div>
            <div class="widget-body">
            	<div class="row" style="margin-left: 20px">
		           <a href="javascript:update()"  class="btn btn-info">更新设备</a>
		           <span style=" color: #ADADAD; font-size: 12px">(PS:尽量在闲时执行此操作)</span>
		          </div>
		          <!-- 
		          <div class="row" style="margin-left: 20px;margin-top: 20px">
		           <a onclick="updateReport()"  class="btn btn-info">更新告警信息</a>
		           <span style=" color: #ADADAD; font-size: 12px">(PS:尽量在闲时执行此操作)</span>
		          </div>
		           -->
            </div>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/device/device.js"></script>	
