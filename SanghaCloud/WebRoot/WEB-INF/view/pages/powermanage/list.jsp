...
<body>
		...
		<div class="widget">
			<div class="widget-header ">
               ...
               <!--     <a href="javascript:void(0)" id="fastAddBtn" class="btn btn-danger">快速</a>-->
                   <a href="<%=basePath%>admin/requestpage/powermanage/edit" id="importBtn"  class="btn btn-info">设置权限</a> 
                </div>
            </div>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/powermanage/list.js"></script>
