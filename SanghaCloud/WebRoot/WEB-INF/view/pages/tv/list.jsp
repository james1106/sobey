...
<body>
    ...
    <div class="page-body">
		<div class="widget">
			<div class="widget-header ">
                <span class="widget-caption">查看列表</span>
                 <div class="widget-buttons">
                 	<a href="<%=basePath%>admin/requestpage/tv/list"  class="btn btn-info">新增电视台</a>
                    <a href="javascript:update()"  class="btn btn-info">更新数据</a>
                </div>
            	...
            	<div class="row">
		          <div class="col-sm-12">
		            <label>
		             ...
		             <label>
						<input type="text" class="form-control spinner-input" placeholder="通过电视台名称查找" id="tvName">
		            </label>
		            <label>
	...
	<script src="<%=basePath%>resource/js/tv/tv.js"></script>
    <script>
    	var totalpage=10;
    	$(function(){
    		addpage(); //加载分页方法
    		
    		totalpage = initData(1,0,null);
    		...
    		$.jqPaginator('#pagination', {
	   	        ...
	   	        onPageChange: function (num, type) {
	   	            ...
	   	            if(type != "init"){
	   	            	...
	   	            	totalpage = initData(num,types,tvName);
	   	            }
	   	        }
	   	    });   
    ...
    $("#qShoppingTemplet").click(function(){
    	...
    	var tvName = $("#tvName").val();
    	var type = $("#type").val();
    	totalpage = initData(1,type,tvName);
    	$.jqPaginator('#pagination', {
	   	    	totalPages: totalpage,  //总页数
	   	        visiblePages: 3,  //可见页面
	   	        currentPage: 1,   //当前页面
