...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/commentcount/user-detail.js"></script>
	<script>
		var totalpage = 10;
		var userId = "${userId}";
		$(function() {
			...
			$.jqPaginator('#pagination', {
				...
				onPageChange : function(num, type) {
					$('#showing').text(
							'共' + totalpage + '页  第'+num+'/' + totalpage + '页');
					if (type != "init") {
						totalpage = initData(num,userId);
					}
				}
			});
		})
