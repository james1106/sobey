...
<body>
	...
	<div class="page-body">
		<div class="widget">
			<div class="widget-header ">
				<span class="widget-caption">查看通知</span>
				<div class="widget-buttons">
					<a href="<%=basePath%>admin/requestpage/notice/add" target="iframe"
						class="btn btn-info">发布通知</a>
				</div>
			</div>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/notice/list.js"></script>
	<script>
		var totalpage = 10;
		$(function() {
			addpage(); //加载分页方法

			totalpage = initData(1);
