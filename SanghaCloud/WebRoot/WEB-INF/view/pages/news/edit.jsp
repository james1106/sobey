...
<body>
    ...
    <div class="page-body">
		<div class="widget">
			<div class="widget-header ">
                <span class="widget-caption">修改资讯</span>
            </div>
            	...
            	<div id="registration-form">
                    <form role="form" id="newsfrom">
                        ...
                        <div class="form-group">
                        	<label>修改图片</label>
                        	<span class="input-icon icon-right">
                        		<input type="radio" name="isEditImage" value="0" checked="checked" id="nonEditImg"/>否
                        		<input type="radio" name="isEditImage" value="1" id="editImg"/>是
                        	</span>
                        </div>
                    	...
                    	<div class="form-group" id="uploadImageDiv" style="display: none">
                            <label>资讯图片&nbsp;&nbsp;<span style="font-size: 12px; color: red">(不修改图片，则不上传)</span></label>
                            <div>
                        ...
                        <div class="form-group">
                        	<label>概要</label>
                        	<span class="input-icon icon-right">
                        		<textarea rows="3" cols="50" style="width: 100%; resize: none;" placeholder="50字以内" id="introduction" name="introduction"></textarea>
                        	</span>
                        </div>
                        <div class="form-group">
                        	<label>Banner置顶</label>
                        	<span class="input-icon icon-right">
                        		<input type="hidden" name="oldIsBanner" id="oldIsBanner">
                        ...
                        <div class="form-group" id="content">
                         ...
                         <div class="form-group" id="closeVoteDiv" style="display: none">
                        	<label>关闭投票</label>
                        	<span class="input-icon icon-right">
                        		<input type="radio" name="isCloseVote" value="0" checked="checked"/>否
                        		<input type="radio" name="isCloseVote" value="1"/>是
                        	</span>
                        </div>
                         
                    </form>
                    <a href="<%=basePath%>admin/requestpage/news" onclick="return confirm(${newsId})" class="btn btn-info">确认修改</a>
	...
	<script src="<%=basePath%>resource/fileupload/js/fileinput.js" type="text/javascript"></script>
  	...
  	<script type="text/javascript" src="<%=basePath%>resource/js/news/edit.js"></script>
    <script>
