	...
	<body>
		<div class="container">
			...
			<div class="download-bar">
				<a href="https://itunes.apple.com/us/app/kou-dai-xiao-bei/id1149183598?l=zh&ls=1&mt=8" class="dropdown-btn ios-btn"><i></i>苹果客户端下载</a><br>
				<a href="https://www.pgyer.com/AXCn" class="dropdown-btn android-btn"><i></i>安卓客户端下载</a>
			</div>
			<div class="qr-bar">
				<p>或者用手机扫描下面的二维码安装</p>
				<img src="<%=request.getContextPath()%>/resource/img/axcn-qr.png" style="width: 156px;height: 156px;">
			</div>
		</div>
	</body>
</html>
